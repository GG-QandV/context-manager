...
export declare const SaveContextBodySchema: import("@sinclair/typebox").TObject<{
    ...
    logicalSection: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"content" | "backend" | "frontend" | "database" | "admin-panel" | "shared" | "infrastructure" | "testing" | "documentation" | "deployment" | "staging" | "production" | "monitoring" | "logging" | "scaling" | "backup" | "disaster-recovery" | "marketing" | "promotion" | "sales" | "branding" | "social-media" | "email-marketing" | "referral" | "affiliate" | "ambassador" | "product" | "features" | "roadmap" | "feedback" | "analytics" | "growth" | "retention" | "churn" | "optimization" | "experimentation" | "customers" | "users" | "audience" | "market" | "competitors" | "pricing" | "monetization" | "subscription" | "support" | "helpdesk" | "faq" | "security" | "compliance" | "privacy" | "incident" | "integrations" | "partnerships" | "apis" | "webhooks">[]>>;
    module: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"shared" | "f1" | "f2" | "f3" | "f4" | "f5" | "f6" | "none">[]>>;
    ...
    deploymentStage: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"development" | "staging" | "production" | "maintenance">[]>>;
...
export declare const LogicalSectionParamSchema: import("@sinclair/typebox").TObject<{
    logicalSection: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"content" | "backend" | "frontend" | "database" | "admin-panel" | "shared" | "infrastructure" | "testing" | "documentation" | "deployment" | "staging" | "production" | "monitoring" | "logging" | "scaling" | "backup" | "disaster-recovery" | "marketing" | "promotion" | "sales" | "branding" | "social-media" | "email-marketing" | "referral" | "affiliate" | "ambassador" | "product" | "features" | "roadmap" | "feedback" | "analytics" | "growth" | "retention" | "churn" | "optimization" | "experimentation" | "customers" | "users" | "audience" | "market" | "competitors" | "pricing" | "monetization" | "subscription" | "support" | "helpdesk" | "faq" | "security" | "compliance" | "privacy" | "incident" | "integrations" | "partnerships" | "apis" | "webhooks">[]>;
}>;
export declare const ModuleParamSchema: import("@sinclair/typebox").TObject<{
    moduleId: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"shared" | "f1" | "f2" | "f3" | "f4" | "f5" | "f6" | "none">[]>;
}>;
...
export declare const DeploymentStageParamSchema: import("@sinclair/typebox").TObject<{
    stage: import("@sinclair/typebox").TUnion<import("@sinclair/typebox").TLiteral<"development" | "staging" | "production" | "maintenance">[]>;
}>;
